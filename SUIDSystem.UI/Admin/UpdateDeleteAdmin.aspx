<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="UpdateDeleteAdmin.aspx.cs" Inherits="SUIDSystem.UI.Admin.UpdateDeleteAdmin" %>
...
<div class="panel panel-success">
  <div class="panel-heading">
    <h3 class="panel-title">Admin Update or Delete</h3>
  </div>
  <div class="panel-body">
      <table style="width:100%">
          ...
          <tr>
              <td class="auto-style10"><asp:Label ID="Label1" Text="Admin ID" runat="server" /></td>
              <td class="auto-style8"><asp:TextBox runat="server" id="txtAdminID" ForeColor="Black" Width="50%" /></td>
      ...
      <br />
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnupdate" Text="Update Admin" class="btn btn-success" runat="server" OnClick="btnupdate_Click" />
      
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                
                <asp:Button ID="btndelete" Text="Delete Admin" class="btn btn-success" runat="server" OnClick="btndelete_Click" />
