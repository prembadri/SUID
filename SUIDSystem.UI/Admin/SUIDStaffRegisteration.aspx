<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="SUIDStaffRegisteration.aspx.cs" Inherits="SUIDSystem.UI.Admin.SUIDStaffRegisteration" %>
...
<div class="panel panel-success">
  <div class="panel-heading">
    <h3 class="panel-title">Staff Registeration</h3>
  </div>
  <div class="panel-body">
      <table style="width:100%">
          ...
          <tr>
              <td class="auto-style10"><asp:Label ID="Label3" Text="Staff Name" runat="server" /></td>
          ...
          <tr>
              ...
              <td class="auto-style9"></td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="btnstaffregister" Text="Add Staff" class="btn btn-success" runat="server" OnClick="btnstaffregister_Click" />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnUpdateDelete" class="btn btn-success" Text="Update And Delete Staff" runat="server" OnClick="btnUpdateDelete_Click" />
...
<ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
    ...
    <li class="active"><a href="../Admin/SUIDStaffRegisteration.aspx">SUID Staff Registeration</a></li>
