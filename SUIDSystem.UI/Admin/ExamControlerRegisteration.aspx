<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ExamControlerRegisteration.aspx.cs" Inherits="SUIDSystem.UI.Admin.ExamControlerRegisteration" %>
...
<div class="panel panel-success">
  <div class="panel-heading">
    <h3 class="panel-title">Exam Controller Registeration</h3>
  </div>
      ...
      <table style="width:100%">
          ...
          <tr>
              ...
              <td class="auto-style9"></td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="btnExamControllerregister" Text="Add Exam Controller" runat="server" OnClick="btnExamControllerregister_Click" class="btn btn-success"/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="BtnUpdateDelete" Text="Update Or Delete" runat="server" OnClick="BtnUpdateDelete_Click" class="btn btn-success" />
...
<ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
    ...
    <li class="active"><a href="../Admin/ExamControlerRegisteration.aspx">Exam Controller Registeration</a></li>
