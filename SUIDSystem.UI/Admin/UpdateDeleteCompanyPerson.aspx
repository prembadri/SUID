<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="UpdateDeleteCompanyPerson.aspx.cs" Inherits="SUIDSystem.UI.Admin.UpdateDeleteCompanyPerson" %>
...
<div class="panel panel-success">
  <div class="panel-heading">
    <h3 class="panel-title">Company's Update or Delete</h3>
  </div>
  <div class="panel-body">
      <table style="width:100%">
          ...
          <tr>
              <td class="auto-style10"><asp:Label ID="Label1" Text="Company EmployeeID" runat="server"/></td>
              <td class="auto-style8"><asp:TextBox runat="server" id="TxtCompanyEmpID" ForeColor="Black" Width="50%" class="form-control"/></td>
              <td class="auto-style9"></td>
          </tr>
