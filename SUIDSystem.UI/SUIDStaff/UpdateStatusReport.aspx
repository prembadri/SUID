<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="UpdateStatusReport.aspx.cs" Inherits="SUIDSystem.UI.SUIDStaff.UpdateStatusReport" %>
          ...
          <tr>
           ...
           <tr>
              ...
              <td class="auto-style9"></td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="btnUpdate" Text="Update Status" runat="server" OnClick="btnUpdate_Click" class="btn btn-success"/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                </div></div>
</asp:Content>
...
<ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
    ...
    <li class="active"><a href="../SUIDStaff/UpdateStatusReport.aspx">Update Status Report</a></li>
