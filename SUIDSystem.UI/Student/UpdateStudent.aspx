<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="UpdateStudent.aspx.cs" Inherits="SUIDSystem.UI.Student.UpdateStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
  ...
  <div class="panel-body" style="height:auto">
      <table style="width:100%">
          <tr>
              <td class="auto-style10"><asp:Label ID="Label16" Text="Student ID" runat="server" For="txtStudentID"/></td>
