<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="InterCertificates.aspx.cs" Inherits="SUIDSystem.UI.Student.InterCertificates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
  ...
  <div class="panel-body" style="height:auto">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="Btn12th" Text="Upload UG Files" runat="server" OnClick="Btn12th_Click" class="btn btn-success" />
      </div></div>
</asp:Content>
