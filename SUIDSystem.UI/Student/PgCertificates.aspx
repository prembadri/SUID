<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="PgCertificates.aspx.cs" Inherits="SUIDSystem.UI.Student.PgCertificates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
  ...
  <div class="panel-heading" style="height:auto">
    <h3 class="panel-title">PG Certificates Uploading</h3>
  </div>
  <div class="panel-body">
      <table style="width:100%">
          <tr>
              <td class="auto-style10"><asp:Label ID="Label3" Text="University Name" runat="server" For="txtBoardName"/></td>
         ...
         <tr>
              <td class="auto-style10"><asp:Label ID="Label6" Text="Student ID Number" runat="server" For="txtStudnetID" Visible="false"/></td>
              <td class="auto-style8"><asp:TextBox runat="server" id="txtStudnetID" ForeColor="Black" Width="50%" class="form-control" Visible="false"/></td>
              <td class="auto-style9"></td>
          </tr>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="btnUpload" Text="Upload" runat="server" OnClick="btnUpload_Click" class="btn btn-success"/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="Btn12th" Text="Upload Other Files" runat="server" OnClick="Btn12th_Click" class="btn btn-success" />
      </div></div>
</asp:Content>
