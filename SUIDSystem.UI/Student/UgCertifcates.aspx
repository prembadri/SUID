<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="UgCertifcates.aspx.cs" Inherits="SUIDSystem.UI.Student.UgCertifcates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
  ...
  <div class="panel-heading">
    <h3 class="panel-title">UG Certificates Uploading</h3>
  </div>
  <div class="panel-body" style="height:auto">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                <asp:Button ID="Btn12th" Text="Upload PG Files" runat="server" OnClick="Btn12th_Click" class="btn btn-success" />
      </div></div>
</asp:Content>
